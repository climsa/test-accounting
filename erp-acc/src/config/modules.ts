...
import fixedAssets from "@/data/fixedAssets.json";
import fixedAssetsDepreciation from "@/data/fixedAssetsDepreciation.json";
import arAging from "@/data/arAging.json";
import apAging from "@/data/apAging.json";
import approvalWorkflow from "@/data/approvalWorkflow.json";
...
const moduleConfigs: Record<string, ModuleConfig<Record<string, unknown>>> = {
  ...
  "fixed-assets/register": {
    title: "Fixed Assets • Asset Register",
    description:
      "Master data aset tetap dengan detail acquisition, depreciation, dan maintenance.",
    data: fixedAssets,
    columns: [
      { key: "assetCode", header: "Kode Aset" },
      { key: "assetName", header: "Nama Aset" },
      { key: "category", header: "Kategori" },
      { key: "location", header: "Lokasi" },
      { key: "custodian", header: "Penanggung Jawab" },
      {
        key: "acquisition.purchaseValue",
        header: "Nilai Beli",
        align: "right",
        renderType: "currency",
      },
      {
        key: "depreciation.bookValue",
        header: "Nilai Buku",
        align: "right",
        renderType: "currency",
      },
      { key: "status.current", header: "Status", renderType: "status" },
    ],
    detailFields: [
      { name: "assetCode", label: "Kode Aset" },
      { name: "assetName", label: "Nama Aset" },
      { name: "category", label: "Kategori" },
      { name: "subCategory", label: "Sub Kategori" },
      { name: "location", label: "Lokasi" },
      { name: "custodian", label: "Penanggung Jawab" },
      { name: "branch", label: "Cabang" },
      { name: "acquisition.purchaseDate", label: "Tanggal Beli" },
      {
        name: "acquisition.purchaseValue",
        label: "Nilai Beli",
        formatType: "currency",
      },
      { name: "acquisition.vendor", label: "Vendor" },
      { name: "depreciation.method", label: "Metode Depresiasi" },
      { name: "depreciation.usefulLife", label: "Masa Manfaat (bulan)" },
      {
        name: "depreciation.monthlyDepreciation",
        label: "Depresiasi Bulanan",
        formatType: "currency",
      },
      {
        name: "depreciation.accumulatedDepreciation",
        label: "Akumulasi Depresiasi",
        formatType: "currency",
      },
      {
        name: "depreciation.bookValue",
        label: "Nilai Buku",
        formatType: "currency",
      },
      { name: "status.condition", label: "Kondisi" },
      { name: "status.lastMaintenance", label: "Maintenance Terakhir" },
      { name: "status.nextMaintenance", label: "Maintenance Berikutnya" },
    ],
    rowActions: [
      { label: "View", intent: "view" },
      { label: "Edit", intent: "edit" },
      {
        ...
        intent: "mock",
        message: "Depresiasi dihitung ulang (mock).",
      },
      {
        label: "Maintenance",
        intent: "mock",
        message: "Jadwal maintenance diperbarui (mock).",
      },
      {
        label: "Transfer",
        intent: "mock",
        message: "Transfer aset ke lokasi lain (mock).",
      },
      { label: "Dispose", intent: "mock", message: "Aset di-dispose (mock)." },
    ],
    form: {
      title: "Aset Tetap",
      fields: [
        ...
        { name: "custodian", label: "Penanggung Jawab" },
        {
          ...
          label: "Cabang",
          type: "select",
          options: ["Klinik A", "Klinik B", "Klinik C"],
        },
        {
        ...
        { name: "acquisition.vendor", label: "Vendor" },
        {
          ...
          type: "select",
          options: ["straight_line", "declining_balance", "sum_of_years"],
        },
        {
  ...
  "fixed-assets/depreciation": {
    ...
    description: "Perhitungan depresiasi bulanan dan posting otomatis ke GL.",
    data: fixedAssetsDepreciation,
    columns: [
      { key: "period", header: "Periode" },
      { key: "assetCode", header: "Kode Aset" },
      { key: "assetName", header: "Nama Aset" },
      { key: "depreciationMethod", header: "Metode" },
      {
        key: "monthlyDepreciation",
        header: "Depresiasi Bulanan",
        align: "right",
        renderType: "currency",
      },
      {
    ...
    detailFields: [
      ...
      { name: "assetCode", label: "Kode Aset" },
      { name: "assetName", label: "Nama Aset" },
      { name: "depreciationMethod", label: "Metode Depresiasi" },
      {
      ...
      { name: "bookValue", label: "Nilai Buku", formatType: "currency" },
      { name: "calculatedDate", label: "Tanggal Hitung" },
      { name: "calculatedBy", label: "Dihitung Oleh" },
      { name: "isPostedToGL", label: "Sudah Post ke GL" },
      { name: "glJournalRef", label: "Referensi Jurnal GL" },
      { name: "postedDate", label: "Tanggal Post" },
      { name: "postedBy", label: "Dipost Oleh" },
    ],
    rowActions: [
      { label: "View", intent: "view" },
      {
        label: "Post to GL",
        intent: "mock",
        message: "Depresiasi dipost ke GL (mock).",
      },
      {
        label: "Reverse",
        intent: "mock",
        message: "Depresiasi di-reverse (mock).",
      },
    ],
    form: {
      title: "Perhitungan Depresiasi",
      fields: [
        { name: "period", label: "Periode" },
        { name: "assetCode", label: "Kode Aset" },
        {
        ...
        },
        {
          ...
          label: "Status",
          type: "select",
          options: ["calculated", "posted", "reversed"],
        },
      ],
    },
  },
  ...
  "reports/ar-aging": {
    title: "Reports • AR Aging Analysis",
    description:
      "Analisis aging piutang pelanggan berdasarkan periode jatuh tempo.",
    data: arAging,
    columns: [
    ...
    detailFields: [
      { name: "customerId", label: "ID Pelanggan" },
      { name: "customerName", label: "Nama Pelanggan" },
      { name: "branch", label: "Cabang" },
      { name: "salesPerson", label: "Sales Person" },
      { name: "current", label: "Current", formatType: "currency" },
      { name: "days30", label: "1-30 Hari", formatType: "currency" },
      { name: "days60", label: "31-60 Hari", formatType: "currency" },
      { name: "days90", label: "61-90 Hari", formatType: "currency" },
      { name: "daysOver90", label: "90+ Hari", formatType: "currency" },
      {
        name: "totalOutstanding",
        label: "Total Outstanding",
        formatType: "currency",
      },
      { name: "creditLimit", label: "Credit Limit", formatType: "currency" },
      {
        name: "availableCredit",
        label: "Available Credit",
        formatType: "currency",
      },
      { name: "lastPaymentDate", label: "Last Payment Date" },
    ...
    rowActions: [
      { label: "View", intent: "view" },
      {
        label: "Send Reminder",
        intent: "mock",
        message: "Reminder dikirim ke pelanggan (mock).",
      },
      {
        label: "Collection Call",
        intent: "mock",
        message: "Jadwal collection call dibuat (mock).",
      },
      {
        label: "Export",
        intent: "mock",
        message: "Laporan aging diekspor (mock).",
      },
    ],
    form: {
      ...
      fields: [
        {
          ...
          label: "Cabang",
          type: "select",
          options: ["All", "Klinik A", "Klinik B", "Klinik C"],
        },
        {
          name: "salesPerson",
          label: "Sales Person",
          type: "select",
          options: ["All", "dr. Citra", "dr. Maya", "dr. Andi", "dr. Budi"],
        },
        {
          name: "status",
          label: "Status",
          type: "select",
          options: ["All", "current", "overdue"],
        },
  ...
  "reports/ap-aging": {
    title: "Reports • AP Aging Analysis",
    description:
      "Analisis aging hutang vendor berdasarkan periode jatuh tempo.",
    data: apAging,
    columns: [
      { key: "vendorName", header: "Vendor" },
      { key: "branch", header: "Cabang" },
      { key: "purchaser", header: "Purchaser" },
      {
        key: "current",
        header: "Current",
        align: "right",
    ...
    detailFields: [
      { name: "vendorId", label: "ID Vendor" },
      { name: "vendorName", label: "Nama Vendor" },
      { name: "branch", label: "Cabang" },
      ...
      { name: "lastPaymentDate", label: "Last Payment Date" },
      { name: "lastBillDate", label: "Last Bill Date" },
      { name: "status", label: "Status" },
    ],
    rowActions: [
      { label: "View", intent: "view" },
      {
        label: "Schedule Payment",
        intent: "mock",
        message: "Jadwal pembayaran dibuat (mock).",
      },
      {
        label: "Negotiate Terms",
        intent: "mock",
        message: "Negosiasi terms dengan vendor (mock).",
      },
      {
        label: "Export",
        intent: "mock",
  ...
  "workflow/approvals": {
    ...
    description:
      "Sistem approval workflow untuk dokumen keuangan dengan multi-level approval.",
    data: approvalWorkflow,
    columns: [
      { key: "id", header: "Approval ID" },
      { key: "documentType", header: "Tipe Dokumen" },
      { key: "documentNumber", header: "No. Dokumen" },
      ...
      { key: "priority", header: "Prioritas", renderType: "status" },
      { key: "status", header: "Status", renderType: "status" },
      { key: "currentLevel", header: "Level" },
      { key: "createdAt", header: "Tanggal Buat" },
    ],
    detailFields: [
      { name: "id", label: "Approval ID" },
      { name: "documentType", label: "Tipe Dokumen" },
      { name: "documentNumber", label: "No. Dokumen" },
      { name: "documentDate", label: "Tanggal Dokumen" },
      { name: "amount", label: "Nilai", formatType: "currency" },
      { name: "currency", label: "Mata Uang" },
      { name: "requester", label: "ID Pemohon" },
      { name: "requesterName", label: "Nama Pemohon" },
      { name: "department", label: "Departemen" },
      { name: "branch", label: "Cabang" },
      { name: "description", label: "Deskripsi" },
      { name: "priority", label: "Prioritas" },
      { name: "status", label: "Status" },
      { name: "currentLevel", label: "Level Saat Ini" },
      { name: "totalLevels", label: "Total Level" },
      { name: "createdAt", label: "Tanggal Buat" },
      { name: "updatedAt", label: "Tanggal Update" },
      { name: "completedAt", label: "Tanggal Selesai" },
    ],
    rowActions: [
      { label: "View", intent: "view" },
      {
        label: "Approve",
        intent: "mock",
        message: "Dokumen disetujui (mock).",
      },
      { label: "Reject", intent: "mock", message: "Dokumen ditolak (mock)." },
      {
        label: "Delegate",
        intent: "mock",
        message: "Approval didelegasikan (mock).",
      },
      {
        label: "Add Comment",
        intent: "mock",
        message: "Komentar ditambahkan (mock).",
      },
      {
        label: "View History",
        intent: "mock",
        message: "Riwayat approval ditampilkan (mock).",
      },
    ],
    form: {
